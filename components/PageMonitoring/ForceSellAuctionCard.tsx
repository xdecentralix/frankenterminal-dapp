...
import { formatCurrency, formatDate, getForceSellAuctionEnd, getForceSellPrice, normalizeAddress } from "@utils";
...
export default function ForceSellAuctionCard({ position }: Props) {
	...
	return (
		<div className="rounded-lg bg-card-content-primary p-3 flex flex-col gap-2">
			...
			<StatRow label="Expired">{formatDate(position.expiration)}</StatRow>
