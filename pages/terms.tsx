		...
		<div className="grid gap-8">
			...
			<div className="relative border border-card-input-border bg-layout-primary px-6 py-6 flex flex-col gap-y-6 rounded-lg text-sm text-text-secondary">
				...
				<div>
					...
					<p>
						The User represents that they are at least 18 years old and have full legal capacity to enter into binding agreements
				...
				<div>
					...
					<ul className="mt-2 list-disc ml-5 space-y-1">
						<li>
							<strong>(a) Sanctions-mandated:</strong> Cuba, Iran, North Korea, Syria, and the Russian-occupied regions of Ukraine
					...
					<p className="mt-2">
						...
						sanctions list, or the Swiss SECO sanctions list. The Operator may add or remove Restricted Jurisdictions at its sole
						discretion; material changes will trigger a new acceptance prompt via the version bump described in section 11.
					</p>
				</div>
				...
				<div>
					...
					<p>
						...
						any signature is requested. By using the relevant features, the User acknowledges and accepts this referral
						arrangement.
					</p>
				</div>
				...
				<div>
					...
					<p>
						These Terms are governed by the substantive laws of Switzerland, excluding its conflict-of-laws rules and excluding the
						United Nations Convention on Contracts for the International Sale of Goods. Subject to any mandatory consumer-
						protection rules in the User&apos;s country of habitual residence, the exclusive place of jurisdiction for any dispute
						arising out of or in connection with these Terms is{" "}
				...
				<div>
					...
					<p>
						If any provision of these Terms is held to be invalid or unenforceable, the remaining provisions shall continue in full
