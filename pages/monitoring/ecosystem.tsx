...
export default function Overview() {
	return (
		<div>
			<Head>
				<title>Frankenterminal · Ecosystem</title>
			</Head>
			...
			<AppTitle title={`Frankencoin Holders`}>
				<div className="text-text-secondary">
					...
					supply reflects tokens held in uncategorized wallets, while other portions are allocated to protocol reserves and
			...
			<AppTitle title={`System Health`}>
				<div className="text-text-secondary">
					Those charts show how well the Frankencoins are backed by collateral assets. All Frankencoins that are not in the
					reserve pool are considered in free circulation. As long as the value is above 100%, all Frankencoins in free
					circulation are backed by collateral. The total supply view shows how well collateral assets back the whole ecosystem.
