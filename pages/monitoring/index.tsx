...
export default function Positions() {
	...
	const collateralCount = useSelector((state: RootState) => state.positions.openPositionsByCollateral.length) + 1; // +1 for CHFAU stablecoin bridge
								...
								<AppTitle title="Collateral Risk Parameters">
									<div className="text-text-secondary flex flex-col gap-2">
										<p>
											...
											liquidation price, and average minimum locked value (average minimum collateral × market price
											across original positions). The avg. min. locked value is the minimum collateral value anyone
											needs to deposit to open a new position and mint new Frankencoin. It also reflects the avg.
											minimum value a challenger needs to provide when starting a challenge.
										</p>
										<p>
